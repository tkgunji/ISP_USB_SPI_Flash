 ...
 *
 * SVN $Revision: 5304 $
 * SVN $Date: 2013-03-23 22:29:23 +0530 (Sat, 23 Mar 2013) $
 */
...
/*=========================================================================*//**
  ...
  Interface Standard" (CMSIS) Hardware abstraction layer to access MSS hardware
  registers. You must ensure that the SmartFusion2 CMSIS is either included
  in the software toolchain used to build your project or is included in your
  project. The most up-to-date SmartFusion2 CMSIS files can be obtained using
