 ...
 * 
 * SmartFusion2 microcontroller subsystem SPI bare metal software driver public API.
 *
 ...
 *
 * SVN $Revision: 5226 $
 * SVN $Date: 2013-03-20 20:13:20 +0530 (Wed, 20 Mar 2013) $
 */
/*=========================================================================*//**
  ...
  MSS SPIs serial signals are routed through IOMUXes to the SmartFusion2 device
  ...
  the IOMUX section of the SmartFusion2 Datasheet.
  The base address, register addresses and interrupt number assignment for the
  MSS SPI blocks are defined as constants in the SmartFusion2 CMSIS-PAL. You must
  ensure that the SmartFusion2 CMSIS-PAL is either included in the software tool
  ...
  SPI slave frame transfer control
    ...
    i.e. if data is meant to be read from the SmartFusion2 device over SPI.
...
/***************************************************************************//**
  ...
  one of the SmartFusion2 MSS SPIs. The MSS_SPI_init() function must be called
